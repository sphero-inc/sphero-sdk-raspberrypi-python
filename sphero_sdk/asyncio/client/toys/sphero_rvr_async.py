...
# Prefix:             RV
# Command Count:      99
# Timestamp:          09/19/2019 @ 19:19:28.665893 (UTC)
...
class SpheroRvrAsync: 
    ...
    async def get_main_application_version(self, target, timeout=None): 
        ...
        Returns:
            tuple: major (uint16_t), minor (uint16_t), revision (uint16_t)
        """
    ...
    async def get_last_error_info(self, timeout=None): 
        ...
        Returns:
            tuple: file_name (list(uint8_t)), line_number (uint16_t), data (list(uint8_t))
        """
    ...
    async def get_event_log_status(self, target, timeout=None): 
        ...
        Returns:
            tuple: log_capacity (uint32_t), number_of_bytes_used (uint32_t), number_of_events_in_log (uint32_t)
        """
    ...
    async def get_battery_voltage_state_thresholds(self, timeout=None): 
        ...
        Returns:
            tuple: critical_threshold (float), low_threshold (float), hysteresis (float)
        """
...
Mask description on BOLT: 32'h0000_00ff: front left sensor 32'h0000_ff00: front right sensor 32'h00ff_0000: back right sensor 32'hff00_0000: back left sensor
    ...
    async def get_rgbc_sensor_values(self, timeout=None): 
        ...
        Returns:
            tuple: red_channel_value (uint16_t), green_channel_value (uint16_t), blue_channel_value (uint16_t), clear_channel_value (uint16_t)
        """
    ...
    async def get_ambient_light_sensor_value(self, timeout=None): 
        ...
        Returns:
            tuple: ambient_light_value (float)
        """
    ...
    async def get_motor_temperature(self, motor_index, timeout=None): 
        ...
        Returns:
            tuple: winding_coil_temperature (float), case_temperature (float)
        """
        command_dict = sensor.get_motor_temperature(motor_index, target=2, timeout=timeout)
        return await self._dal.send_command(**command_dict)

    async def configure_sensitivity_based_collision_detection(self, method, sensitivity, dead_time, timeout=None): 
    ...
    async def enable_sensitivity_based_collision_detection_notify(self, is_enabled, timeout=None): 
    ...
    async def on_sensitivity_based_collision_detected_notify(self, handler=None, timeout=None): 
        """Collision detection notification

        Args:
            handler (function): called asynchronously, takes form handler(time).
            timeout (float): maximum time to await a response.
        Returns:
            Task (Future) from which `handler` will be called
        """
    ...
    async def get_motor_thermal_protection_status(self, timeout=None): 
        ...
        Returns:
            tuple: left_motor_temperature (float), left_motor_status (uint8_t), right_motor_temperature (float), right_motor_status (uint8_t)
        """
    ...
    async def get_compressed_frame_player_list_of_frames(self, timeout=None): 
        ...
        Returns:
            tuple: frame_indexes (list(uint16_t))
        """
    ...
    async def save_compressed_frame_player_animation_without_frames(self, animation_index, speed_fps, is_fade_enabled, palette_color_count, palette_rgb_values, total_frame_count, timeout=None): 
        ...
        Returns:
            tuple: saved_animations (list(uint8_t))
        """
    ...
    async def get_active_color_palette(self, timeout=None): 
        ...
        Returns:
            tuple: rgb_index_bytes (list(uint8_t))
        """
    ...
    async def get_color_identification_report(self, red, green, blue, confidence_threshold, timeout=None): 
        ...
        Returns:
            tuple: index_confidence_byte (list(uint8_t))
        """
