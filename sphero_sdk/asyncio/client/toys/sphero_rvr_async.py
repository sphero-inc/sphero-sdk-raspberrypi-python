...
# Prefix:             RV
# Command Count:      93
# Timestamp:          07/10/2020 @ 05:06:56.543105 (UTC)
...
class SpheroRvrAsync(RvrFwCheckAsync): 
    ...
    async def echo(self, data, target, timeout=None, request_error=False): 
        ...
        Args:
            ...
            request_error (bool): requests error response even if no output is expected.

        Returns:
            dict: data (list(uint8_t))
        """
        command_dict = api_and_shell.echo(data, target=target, timeout=timeout, request_error=request_error)
        return await self._dal.send_command(**command_dict)

    async def generate_api_error(self, error, target, timeout=None, request_error=False): 
        ...
        Args:
            ...
            request_error (bool): requests error response even if no output is expected.
        """
        command_dict = api_and_shell.generate_api_error(error, target=target, timeout=timeout, request_error=request_error)
        return await self._dal.send_command(**command_dict)

    async def get_main_application_version(self, target, timeout=None, request_error=False): 
        ...
        """
        command_dict = system_info.get_main_application_version(target=target, timeout=timeout, request_error=request_error)
        return await self._dal.send_command(**command_dict)

    async def get_bootloader_version(self, target, timeout=None, request_error=False): 
        ...
        Returns:
            dict: major (uint16_t), minor (uint16_t), revision (uint16_t)
        """
        command_dict = system_info.get_bootloader_version(target=target, timeout=timeout, request_error=request_error)
        return await self._dal.send_command(**command_dict)

    async def get_board_revision(self, timeout=None, request_error=False): 
        ...
        """
        command_dict = system_info.get_board_revision(timeout=timeout, target=1, request_error=request_error)
        return await self._dal.send_command(**command_dict)

    async def get_mac_address(self, timeout=None, request_error=False): 
        ...
        """
        command_dict = system_info.get_mac_address(timeout=timeout, target=1, request_error=request_error)
        return await self._dal.send_command(**command_dict)

    async def get_stats_id(self, timeout=None, request_error=False): 
        ...
        """
        command_dict = system_info.get_stats_id(timeout=timeout, target=1, request_error=request_error)
        return await self._dal.send_command(**command_dict)

    async def get_processor_name(self, target, timeout=None, request_error=False): 
        ...
        Returns:
            dict: name (str)
        """
        command_dict = system_info.get_processor_name(target=target, timeout=timeout, request_error=request_error)
        return await self._dal.send_command(**command_dict)

    async def get_sku(self, timeout=None, request_error=False): 
        ...
        Returns:
            dict: sku (str)
        """
        command_dict = system_info.get_sku(timeout=timeout, target=1, request_error=request_error)
        return await self._dal.send_command(**command_dict)

    async def get_core_up_time_in_milliseconds(self, timeout=None, request_error=False): 
        ...
        """
        command_dict = system_info.get_core_up_time_in_milliseconds(timeout=timeout, target=1, request_error=request_error)
        return await self._dal.send_command(**command_dict)

    async def sleep(self, timeout=None, request_error=False): 
        ...
        Args:
            ...
            request_error (bool): requests error response even if no output is expected.
        """
        command_dict = power.sleep(timeout=timeout, target=1, request_error=request_error)
        return await self._dal.send_command(**command_dict)

    async def wake(self, timeout=None, request_error=False): 
        ...
        Args:
            ...
            request_error (bool): requests error response even if no output is expected.
        """
        command_dict = power.wake(timeout=timeout, target=1, request_error=request_error)
        return await self._dal.send_command(**command_dict)

    async def get_battery_percentage(self, timeout=None, request_error=False): 
        ...
        """
        command_dict = power.get_battery_percentage(timeout=timeout, target=1, request_error=request_error)
        return await self._dal.send_command(**command_dict)

    async def get_battery_voltage_state(self, timeout=None, request_error=False): 
        ...
        Returns:
            dict: state (uint8_t)
        """
        command_dict = power.get_battery_voltage_state(timeout=timeout, target=1, request_error=request_error)
        return await self._dal.send_command(**command_dict)
    ...
    async def enable_battery_voltage_state_change_notify(self, is_enabled, timeout=None, request_error=False): 
        ...
        Args:
            ...
            request_error (bool): requests error response even if no output is expected.
        """
        command_dict = power.enable_battery_voltage_state_change_notify(is_enabled, timeout=timeout, target=1, request_error=request_error)
        return await self._dal.send_command(**command_dict)
    ...
    async def get_battery_voltage_in_volts(self, reading_type, timeout=None, request_error=False): 
        ...
        Returns:
            dict: voltage (float)
        """
        command_dict = power.get_battery_voltage_in_volts(reading_type, timeout=timeout, target=1, request_error=request_error)
        return await self._dal.send_command(**command_dict)

    async def get_battery_voltage_state_thresholds(self, timeout=None, request_error=False): 
        ...
        """
        command_dict = power.get_battery_voltage_state_thresholds(timeout=timeout, target=1, request_error=request_error)
        return await self._dal.send_command(**command_dict)

    async def get_current_sense_amplifier_current(self, amplifier_id, timeout=None, request_error=False): 
        ...
        """
        command_dict = power.get_current_sense_amplifier_current(amplifier_id, timeout=timeout, target=1, request_error=request_error)
        return await self._dal.send_command(**command_dict)

    async def raw_motors(self, left_mode, left_speed, right_mode, right_speed, timeout=None, request_error=False): 
        ...
        Args:
            ...
            request_error (bool): requests error response even if no output is expected.
        """
        command_dict = drive.raw_motors(left_mode, left_speed, right_mode, right_speed, timeout=timeout, target=2, request_error=request_error)
        return await self._dal.send_command(**command_dict)

    async def reset_yaw(self, timeout=None, request_error=False): 
        ...
        Args:
            ...
            request_error (bool): requests error response even if no output is expected.
        """
        command_dict = drive.reset_yaw(timeout=timeout, target=2, request_error=request_error)
        return await self._dal.send_command(**command_dict)

    async def drive_with_heading(self, speed, heading, flags, timeout=None, request_error=False): 
        ...
        Args:
            ...
            request_error (bool): requests error response even if no output is expected.
        """
        command_dict = drive.drive_with_heading(speed, heading, flags, timeout=timeout, target=2, request_error=request_error)
        return await self._dal.send_command(**command_dict)

    async def set_default_control_system_for_type(self, control_system_type, controller_id, timeout=None, request_error=False): 
        ...
        Args:
            ...
            request_error (bool): requests error response even if no output is expected.
        """
        command_dict = drive.set_default_control_system_for_type(control_system_type, controller_id, timeout=timeout, target=2, request_error=request_error)
        return await self._dal.send_command(**command_dict)

    async def set_custom_control_system_timeout(self, command_timeout, timeout=None, request_error=False): 
        ...
        Args:
            ...
            request_error (bool): requests error response even if no output is expected.
        """
        command_dict = drive.set_custom_control_system_timeout(command_timeout, timeout=timeout, target=2, request_error=request_error)
        return await self._dal.send_command(**command_dict)

    async def enable_motor_stall_notify(self, is_enabled, timeout=None, request_error=False): 
        ...
        Args:
            ...
            request_error (bool): requests error response even if no output is expected.
        """
        command_dict = drive.enable_motor_stall_notify(is_enabled, timeout=timeout, target=2, request_error=request_error)
        return await self._dal.send_command(**command_dict)
    ...
    async def enable_motor_fault_notify(self, is_enabled, timeout=None, request_error=False): 
        ...
        Args:
            ...
            request_error (bool): requests error response even if no output is expected.
        """
        command_dict = drive.enable_motor_fault_notify(is_enabled, timeout=timeout, target=2, request_error=request_error)
        return await self._dal.send_command(**command_dict)
    ...
    async def get_motor_fault_state(self, timeout=None, request_error=False): 
        ...
        Returns:
            dict: is_fault (bool)
        """
        command_dict = drive.get_motor_fault_state(timeout=timeout, target=2, request_error=request_error)
        return await self._dal.send_command(**command_dict)

    async def drive_tank_si_units(self, left_velocity, right_velocity, timeout=None, request_error=False): 
        ...
        Args:
            ...
            request_error (bool): requests error response even if no output is expected.
        """
        command_dict = drive.drive_tank_si_units(left_velocity, right_velocity, timeout=timeout, target=2, request_error=request_error)
        return await self._dal.send_command(**command_dict)

    async def drive_tank_normalized(self, left_velocity, right_velocity, timeout=None, request_error=False): 
        ...
        Args:
            ...
            request_error (bool): requests error response even if no output is expected.
        """
        command_dict = drive.drive_tank_normalized(left_velocity, right_velocity, timeout=timeout, target=2, request_error=request_error)
        return await self._dal.send_command(**command_dict)

    async def drive_rc_si_units(self, yaw_angular_velocity, linear_velocity, flags, timeout=None, request_error=False): 
        ...
        Args:
            ...
            request_error (bool): requests error response even if no output is expected.
        """
        command_dict = drive.drive_rc_si_units(yaw_angular_velocity, linear_velocity, flags, timeout=timeout, target=2, request_error=request_error)
        return await self._dal.send_command(**command_dict)

    async def drive_rc_normalized(self, yaw_angular_velocity, linear_velocity, flags, timeout=None, request_error=False): 
        ...
        Args:
            ...
            request_error (bool): requests error response even if no output is expected.
        """
        command_dict = drive.drive_rc_normalized(yaw_angular_velocity, linear_velocity, flags, timeout=timeout, target=2, request_error=request_error)
        return await self._dal.send_command(**command_dict)

    async def drive_with_yaw_si(self, yaw_angle, linear_velocity, timeout=None, request_error=False): 
        ...
        Args:
            ...
            request_error (bool): requests error response even if no output is expected.
        """
        command_dict = drive.drive_with_yaw_si(yaw_angle, linear_velocity, timeout=timeout, target=2, request_error=request_error)
        return await self._dal.send_command(**command_dict)

    async def drive_with_yaw_normalized(self, yaw_angle, linear_velocity, timeout=None, request_error=False): 
        ...
        Args:
            ...
            request_error (bool): requests error response even if no output is expected.
        """
        command_dict = drive.drive_with_yaw_normalized(yaw_angle, linear_velocity, timeout=timeout, target=2, request_error=request_error)
        return await self._dal.send_command(**command_dict)

    async def drive_to_position_si(self, yaw_angle, x, y, linear_speed, flags, timeout=None, request_error=False): 
        ...
        Args:
            ...
            request_error (bool): requests error response even if no output is expected.
        """
        command_dict = drive.drive_to_position_si(yaw_angle, x, y, linear_speed, flags, timeout=timeout, target=2, request_error=request_error)
        return await self._dal.send_command(**command_dict)

    async def drive_to_position_normalized(self, yaw_angle, x, y, linear_speed, flags, timeout=None, request_error=False): 
        ...
        Args:
            ...
            request_error (bool): requests error response even if no output is expected.
        """
        command_dict = drive.drive_to_position_normalized(yaw_angle, x, y, linear_speed, flags, timeout=timeout, target=2, request_error=request_error)
        return await self._dal.send_command(**command_dict)
    ...
    async def set_drive_target_slew_parameters(self, a, b, c, linear_acceleration, linear_velocity_slew_method, timeout=None, request_error=False): 
...
linearAcceleration is in m/s.  LinearVelocitySlewMethod determines the meaning of linearAcceleration
        ...
        Args:
            ...
            request_error (bool): requests error response even if no output is expected.
        """
        command_dict = drive.set_drive_target_slew_parameters(a, b, c, linear_acceleration, linear_velocity_slew_method, timeout=timeout, target=2, request_error=request_error)
        return await self._dal.send_command(**command_dict)

    async def get_drive_target_slew_parameters(self, timeout=None, request_error=False): 
...
linearAcceleration is in m/s.  LinearVelocitySlewMethod determines the meaning of linearAcceleration
        ...
        """
        command_dict = drive.get_drive_target_slew_parameters(timeout=timeout, target=2, request_error=request_error)
        return await self._dal.send_command(**command_dict)

    async def stop_active_controller_custom_decel(self, deceleration_rate, timeout=None, request_error=False): 
        ...
        Args:
            ...
            request_error (bool): requests error response even if no output is expected.
        """
        command_dict = drive.stop_active_controller_custom_decel(deceleration_rate, timeout=timeout, target=2, request_error=request_error)
        return await self._dal.send_command(**command_dict)
    ...
    async def restore_default_drive_target_slew_parameters(self, timeout=None, request_error=False): 
        ...
        Args:
            ...
            request_error (bool): requests error response even if no output is expected.
        """
        command_dict = drive.restore_default_drive_target_slew_parameters(timeout=timeout, target=2, request_error=request_error)
        return await self._dal.send_command(**command_dict)

    async def get_stop_controller_state(self, timeout=None, request_error=False): 
        ...
        Returns:
            dict: stopped (bool)
        """
        command_dict = drive.get_stop_controller_state(timeout=timeout, target=2, request_error=request_error)
        return await self._dal.send_command(**command_dict)

    async def stop_active_controller(self, timeout=None, request_error=False): 
        ...
        Args:
            ...
            request_error (bool): requests error response even if no output is expected.
        """
        command_dict = drive.stop_active_controller(timeout=timeout, target=2, request_error=request_error)
        return await self._dal.send_command(**command_dict)

    async def restore_default_control_system_timeout(self, timeout=None, request_error=False): 
        ...
        Args:
            ...
            request_error (bool): requests error response even if no output is expected.
        """
        command_dict = drive.restore_default_control_system_timeout(timeout=timeout, target=2, request_error=request_error)
        return await self._dal.send_command(**command_dict)

    async def get_active_control_system_id(self, timeout=None, request_error=False): 
        ...
        """
        command_dict = drive.get_active_control_system_id(timeout=timeout, target=2, request_error=request_error)
        return await self._dal.send_command(**command_dict)

    async def restore_initial_default_control_systems(self, timeout=None, request_error=False): 
        ...
        Args:
            ...
            request_error (bool): requests error response even if no output is expected.
        """
        command_dict = drive.restore_initial_default_control_systems(timeout=timeout, target=2, request_error=request_error)
        return await self._dal.send_command(**command_dict)

    async def get_default_control_system_for_type(self, control_system_type, timeout=None, request_error=False): 
        ...
        Returns:
            dict: controller_id (uint8_t)
        """
        command_dict = drive.get_default_control_system_for_type(control_system_type, timeout=timeout, target=2, request_error=request_error)
        return await self._dal.send_command(**command_dict)

    async def enable_gyro_max_notify(self, is_enabled, timeout=None, request_error=False): 
        ...
        Args:
            ...
            request_error (bool): requests error response even if no output is expected.
        """
        command_dict = sensor.enable_gyro_max_notify(is_enabled, timeout=timeout, target=2, request_error=request_error)
        return await self._dal.send_command(**command_dict)
    ...
    async def reset_locator_x_and_y(self, timeout=None, request_error=False): 
        ...
        Args:
            ...
            request_error (bool): requests error response even if no output is expected.
        """
        command_dict = sensor.reset_locator_x_and_y(timeout=timeout, target=2, request_error=request_error)
        return await self._dal.send_command(**command_dict)

    async def set_locator_flags(self, flags, timeout=None, request_error=False): 
        ...
        Args:
            ...
            request_error (bool): requests error response even if no output is expected.
        """
        command_dict = sensor.set_locator_flags(flags, timeout=timeout, target=2, request_error=request_error)
        return await self._dal.send_command(**command_dict)

    async def get_bot_to_bot_infrared_readings(self, timeout=None, request_error=False): 
...
Mask description on BOLT: 32'h0000_00ff: front left sensor 32'h0000_ff00: front right sensor 32'h00ff_0000: back right sensor 32'hff00_0000: back left sensor
        ...
        """
        command_dict = sensor.get_bot_to_bot_infrared_readings(timeout=timeout, target=2, request_error=request_error)
        return await self._dal.send_command(**command_dict)

    async def get_rgbc_sensor_values(self, timeout=None, request_error=False): 
        ...
        """
        command_dict = sensor.get_rgbc_sensor_values(timeout=timeout, target=1, request_error=request_error)
        return await self._dal.send_command(**command_dict)

    async def magnetometer_calibrate_to_north(self, timeout=None, request_error=False): 
        ...
        Args:
            ...
            request_error (bool): requests error response even if no output is expected.
        """
        command_dict = sensor.magnetometer_calibrate_to_north(timeout=timeout, target=2, request_error=request_error)
        return await self._dal.send_command(**command_dict)

    async def start_robot_to_robot_infrared_broadcasting(self, far_code, near_code, timeout=None, request_error=False): 
        ...
        Args:
            ...
            request_error (bool): requests error response even if no output is expected.
        """
        command_dict = sensor.start_robot_to_robot_infrared_broadcasting(far_code, near_code, timeout=timeout, target=2, request_error=request_error)
        return await self._dal.send_command(**command_dict)

    async def start_robot_to_robot_infrared_following(self, far_code, near_code, timeout=None, request_error=False): 
        ...
        Args:
            ...
            request_error (bool): requests error response even if no output is expected.
        """
        command_dict = sensor.start_robot_to_robot_infrared_following(far_code, near_code, timeout=timeout, target=2, request_error=request_error)
        return await self._dal.send_command(**command_dict)

    async def stop_robot_to_robot_infrared_broadcasting(self, timeout=None, request_error=False): 
        ...
        Args:
            ...
            request_error (bool): requests error response even if no output is expected.
        """
        command_dict = sensor.stop_robot_to_robot_infrared_broadcasting(timeout=timeout, target=2, request_error=request_error)
        return await self._dal.send_command(**command_dict)
    ...
    async def get_ambient_light_sensor_value(self, timeout=None, request_error=False): 
        ...
        """
        command_dict = sensor.get_ambient_light_sensor_value(timeout=timeout, target=1, request_error=request_error)
        return await self._dal.send_command(**command_dict)

    async def stop_robot_to_robot_infrared_following(self, timeout=None, request_error=False): 
        ...
        Args:
            ...
            request_error (bool): requests error response even if no output is expected.
        """
        command_dict = sensor.stop_robot_to_robot_infrared_following(timeout=timeout, target=2, request_error=request_error)
        return await self._dal.send_command(**command_dict)

    async def start_robot_to_robot_infrared_evading(self, far_code, near_code, timeout=None, request_error=False): 
        ...
        Args:
            ...
            request_error (bool): requests error response even if no output is expected.
        """
        command_dict = sensor.start_robot_to_robot_infrared_evading(far_code, near_code, timeout=timeout, target=2, request_error=request_error)
        return await self._dal.send_command(**command_dict)

    async def stop_robot_to_robot_infrared_evading(self, timeout=None, request_error=False): 
        ...
        Args:
            ...
            request_error (bool): requests error response even if no output is expected.
        """
        command_dict = sensor.stop_robot_to_robot_infrared_evading(timeout=timeout, target=2, request_error=request_error)
        return await self._dal.send_command(**command_dict)

    async def enable_color_detection_notify(self, is_enabled, interval, minimum_confidence_threshold, timeout=None, request_error=False): 
        ...
        Args:
            ...
            request_error (bool): requests error response even if no output is expected.
        """
        command_dict = sensor.enable_color_detection_notify(is_enabled, interval, minimum_confidence_threshold, timeout=timeout, target=1, request_error=request_error)
        return await self._dal.send_command(**command_dict)
    ...
    async def get_current_detected_color_reading(self, timeout=None, request_error=False): 
        ...
        Args:
            ...
            request_error (bool): requests error response even if no output is expected.
        """
        command_dict = sensor.get_current_detected_color_reading(timeout=timeout, target=1, request_error=request_error)
        return await self._dal.send_command(**command_dict)

    async def enable_color_detection(self, is_enabled, timeout=None, request_error=False): 
        ...
        Args:
            ...
            request_error (bool): requests error response even if no output is expected.
        """
        command_dict = sensor.enable_color_detection(is_enabled, timeout=timeout, target=1, request_error=request_error)
        return await self._dal.send_command(**command_dict)

    async def configure_streaming_service(self, token, configuration, target, timeout=None, request_error=False): 
        ...
        Args:
            ...
            request_error (bool): requests error response even if no output is expected.
        """
        command_dict = sensor.configure_streaming_service(token, configuration, target=target, timeout=timeout, request_error=request_error)
        return await self._dal.send_command(**command_dict)

    async def start_streaming_service(self, period, target, timeout=None, request_error=False): 
        ...
        Args:
            ...
            request_error (bool): requests error response even if no output is expected.
        """
        command_dict = sensor.start_streaming_service(period, target=target, timeout=timeout, request_error=request_error)
        return await self._dal.send_command(**command_dict)

    async def stop_streaming_service(self, target, timeout=None, request_error=False): 
        ...
        Args:
            ...
            request_error (bool): requests error response even if no output is expected.
        """
        command_dict = sensor.stop_streaming_service(target=target, timeout=timeout, request_error=request_error)
        return await self._dal.send_command(**command_dict)

    async def clear_streaming_service(self, target, timeout=None, request_error=False): 
        ...
        Args:
            ...
            request_error (bool): requests error response even if no output is expected.
        """
        command_dict = sensor.clear_streaming_service(target=target, timeout=timeout, request_error=request_error)
        return await self._dal.send_command(**command_dict)
    ...
    async def enable_robot_infrared_message_notify(self, is_enabled, timeout=None, request_error=False): 
        ...
        Args:
            ...
            request_error (bool): requests error response even if no output is expected.
        """
        command_dict = sensor.enable_robot_infrared_message_notify(is_enabled, timeout=timeout, target=2, request_error=request_error)
        return await self._dal.send_command(**command_dict)

    async def send_infrared_message(self, infrared_code, front_strength, left_strength, right_strength, rear_strength, timeout=None, request_error=False): 
        ...
        Args:
            ...
            request_error (bool): requests error response even if no output is expected.
        """
        command_dict = sensor.send_infrared_message(infrared_code, front_strength, left_strength, right_strength, rear_strength, timeout=timeout, target=2, request_error=request_error)
        return await self._dal.send_command(**command_dict)

    async def get_temperature(self, id0, id1, timeout=None, request_error=False): 
        ...
        """
        command_dict = sensor.get_temperature(id0, id1, timeout=timeout, target=2, request_error=request_error)
        return await self._dal.send_command(**command_dict)

    async def get_motor_thermal_protection_status(self, timeout=None, request_error=False): 
        ...
        """
        command_dict = sensor.get_motor_thermal_protection_status(timeout=timeout, target=2, request_error=request_error)
        return await self._dal.send_command(**command_dict)

    async def enable_motor_thermal_protection_status_notify(self, is_enabled, timeout=None, request_error=False): 
        ...
        Args:
            ...
            request_error (bool): requests error response even if no output is expected.
        """
        command_dict = sensor.enable_motor_thermal_protection_status_notify(is_enabled, timeout=timeout, target=2, request_error=request_error)
        return await self._dal.send_command(**command_dict)
    ...
    async def get_magnetometer_reading(self, timeout=None, request_error=False): 
        ...
        """
        command_dict = sensor.get_magnetometer_reading(timeout=timeout, target=2, request_error=request_error)
        return await self._dal.send_command(**command_dict)

    async def get_encoder_counts(self, timeout=None, request_error=False): 
        ...
        """
        command_dict = sensor.get_encoder_counts(timeout=timeout, target=2, request_error=request_error)
        return await self._dal.send_command(**command_dict)

    async def disable_notifications_and_active_commands(self, timeout=None, request_error=False): 
        ...
        Args:
            ...
            request_error (bool): requests error response even if no output is expected.
        """
        command_dict = sensor.disable_notifications_and_active_commands(timeout=timeout, target=1, request_error=request_error)
        return await self._dal.send_command(**command_dict)

    async def get_bluetooth_advertising_name(self, timeout=None, request_error=False): 
        ...
        Returns:
            dict: name (str)
        """
        command_dict = connection.get_bluetooth_advertising_name(timeout=timeout, target=1, request_error=request_error)
        return await self._dal.send_command(**command_dict)

    async def set_all_leds(self, led_group, led_brightness_values, timeout=None, request_error=False): 
        ...
        Args:
            ...
            request_error (bool): requests error response even if no output is expected.
        """
        command_dict = io.set_all_leds(led_group, led_brightness_values, timeout=timeout, target=1, request_error=request_error)
        return await self._dal.send_command(**command_dict)

    async def get_active_color_palette(self, timeout=None, request_error=False): 
        ...
        """
        command_dict = io.get_active_color_palette(timeout=timeout, target=1, request_error=request_error)
        return await self._dal.send_command(**command_dict)

    async def set_active_color_palette(self, rgb_index_bytes, timeout=None, request_error=False): 
        ...
        Args:
            ...
            request_error (bool): requests error response even if no output is expected.
        """
        command_dict = io.set_active_color_palette(rgb_index_bytes, timeout=timeout, target=1, request_error=request_error)
        return await self._dal.send_command(**command_dict)

    async def get_color_identification_report(self, red, green, blue, confidence_threshold, timeout=None, request_error=False): 
        ...
        """
        command_dict = io.get_color_identification_report(red, green, blue, confidence_threshold, timeout=timeout, target=1, request_error=request_error)
        return await self._dal.send_command(**command_dict)

    async def load_color_palette(self, palette_index, timeout=None, request_error=False): 
        ...
        Args:
            ...
            request_error (bool): requests error response even if no output is expected.
        """
        command_dict = io.load_color_palette(palette_index, timeout=timeout, target=1, request_error=request_error)
        return await self._dal.send_command(**command_dict)

    async def save_color_palette(self, palette_index, timeout=None, request_error=False): 
        ...
        Args:
            ...
            request_error (bool): requests error response even if no output is expected.
        """
        command_dict = io.save_color_palette(palette_index, timeout=timeout, target=1, request_error=request_error)
        return await self._dal.send_command(**command_dict)

    async def release_led_requests(self, timeout=None, request_error=False): 
        ...
        Args:
            ...
            request_error (bool): requests error response even if no output is expected.
        """
        command_dict = io.release_led_requests(timeout=timeout, target=1, request_error=request_error)
        return await self._dal.send_command(**command_dict)
