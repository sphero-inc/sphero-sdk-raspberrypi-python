...
# Prefix:             RV
# Command Count:      93
# Timestamp:          07/10/2020 @ 05:06:56.548596 (UTC)
...
class SpheroRvrObserver(Observer, RvrFwCheckObserver): 
    ...
    def echo(self, data, handler, target, timeout=None, request_error=False): 
    ...
    def generate_api_error(self, error, target, timeout=None, request_error=False): 
    ...
    def get_main_application_version(self, handler, target, timeout=None, request_error=False): 
    ...
    def get_bootloader_version(self, handler, target, timeout=None, request_error=False): 
    ...
    def get_board_revision(self, handler, timeout=None, request_error=False): 
    ...
    def get_mac_address(self, handler, timeout=None, request_error=False): 
    ...
    def get_stats_id(self, handler, timeout=None, request_error=False): 
    ...
    def get_processor_name(self, handler, target, timeout=None, request_error=False): 
    ...
    def get_sku(self, handler, timeout=None, request_error=False): 
    ...
    def get_core_up_time_in_milliseconds(self, handler, timeout=None, request_error=False): 
    ...
    def sleep(self, timeout=None, request_error=False): 
    ...
    def wake(self, timeout=None, request_error=False): 
    ...
    def get_battery_percentage(self, handler, timeout=None, request_error=False): 
    ...
    def get_battery_voltage_state(self, handler, timeout=None, request_error=False): 
    ...
    def enable_battery_voltage_state_change_notify(self, is_enabled, timeout=None, request_error=False): 
    ...
    def get_battery_voltage_in_volts(self, reading_type, handler, timeout=None, request_error=False): 
    ...
    def get_battery_voltage_state_thresholds(self, handler, timeout=None, request_error=False): 
    ...
    def get_current_sense_amplifier_current(self, amplifier_id, handler, timeout=None, request_error=False): 
    ...
    def raw_motors(self, left_mode, left_speed, right_mode, right_speed, timeout=None, request_error=False): 
    ...
    def reset_yaw(self, timeout=None, request_error=False): 
    ...
    def drive_with_heading(self, speed, heading, flags, timeout=None, request_error=False): 
    ...
    def set_default_control_system_for_type(self, control_system_type, controller_id, timeout=None, request_error=False): 
    ...
    def set_custom_control_system_timeout(self, command_timeout, timeout=None, request_error=False): 
    ...
    def enable_motor_stall_notify(self, is_enabled, timeout=None, request_error=False): 
    ...
    def enable_motor_fault_notify(self, is_enabled, timeout=None, request_error=False): 
    ...
    def get_motor_fault_state(self, handler, timeout=None, request_error=False): 
    ...
    def drive_tank_si_units(self, left_velocity, right_velocity, timeout=None, request_error=False): 
    ...
    def drive_tank_normalized(self, left_velocity, right_velocity, timeout=None, request_error=False): 
    ...
    def drive_rc_si_units(self, yaw_angular_velocity, linear_velocity, flags, timeout=None, request_error=False): 
    ...
    def drive_rc_normalized(self, yaw_angular_velocity, linear_velocity, flags, timeout=None, request_error=False): 
    ...
    def drive_with_yaw_si(self, yaw_angle, linear_velocity, timeout=None, request_error=False): 
    ...
    def drive_with_yaw_normalized(self, yaw_angle, linear_velocity, timeout=None, request_error=False): 
    ...
    def drive_to_position_si(self, yaw_angle, x, y, linear_speed, flags, timeout=None, request_error=False): 
    ...
    def drive_to_position_normalized(self, yaw_angle, x, y, linear_speed, flags, timeout=None, request_error=False): 
    ...
    def set_drive_target_slew_parameters(self, a, b, c, linear_acceleration, linear_velocity_slew_method, timeout=None, request_error=False): 
...
linearAcceleration is in m/s.  LinearVelocitySlewMethod determines the meaning of linearAcceleration
    ...
    def get_drive_target_slew_parameters(self, handler, timeout=None, request_error=False): 
...
linearAcceleration is in m/s.  LinearVelocitySlewMethod determines the meaning of linearAcceleration
    ...
    def stop_active_controller_custom_decel(self, deceleration_rate, timeout=None, request_error=False): 
    ...
    def restore_default_drive_target_slew_parameters(self, timeout=None, request_error=False): 
    ...
    def get_stop_controller_state(self, handler, timeout=None, request_error=False): 
    ...
    def stop_active_controller(self, timeout=None, request_error=False): 
    ...
    def restore_default_control_system_timeout(self, timeout=None, request_error=False): 
    ...
    def get_active_control_system_id(self, handler, timeout=None, request_error=False): 
    ...
    def restore_initial_default_control_systems(self, timeout=None, request_error=False): 
    ...
    def get_default_control_system_for_type(self, control_system_type, handler, timeout=None, request_error=False): 
    ...
    def enable_gyro_max_notify(self, is_enabled, timeout=None, request_error=False): 
    ...
    def reset_locator_x_and_y(self, timeout=None, request_error=False): 
    ...
    def set_locator_flags(self, flags, timeout=None, request_error=False): 
    ...
    def get_bot_to_bot_infrared_readings(self, handler, timeout=None, request_error=False): 
...
Mask description on BOLT: 32'h0000_00ff: front left sensor 32'h0000_ff00: front right sensor 32'h00ff_0000: back right sensor 32'hff00_0000: back left sensor
    ...
    def get_rgbc_sensor_values(self, handler, timeout=None, request_error=False): 
    ...
    def magnetometer_calibrate_to_north(self, timeout=None, request_error=False): 
    ...
    def start_robot_to_robot_infrared_broadcasting(self, far_code, near_code, timeout=None, request_error=False): 
    ...
    def start_robot_to_robot_infrared_following(self, far_code, near_code, timeout=None, request_error=False): 
    ...
    def stop_robot_to_robot_infrared_broadcasting(self, timeout=None, request_error=False): 
    ...
    def get_ambient_light_sensor_value(self, handler, timeout=None, request_error=False): 
    ...
    def stop_robot_to_robot_infrared_following(self, timeout=None, request_error=False): 
    ...
    def start_robot_to_robot_infrared_evading(self, far_code, near_code, timeout=None, request_error=False): 
    ...
    def stop_robot_to_robot_infrared_evading(self, timeout=None, request_error=False): 
    ...
    def enable_color_detection_notify(self, is_enabled, interval, minimum_confidence_threshold, timeout=None, request_error=False): 
    ...
    def get_current_detected_color_reading(self, timeout=None, request_error=False): 
    ...
    def enable_color_detection(self, is_enabled, timeout=None, request_error=False): 
    ...
    def configure_streaming_service(self, token, configuration, target, timeout=None, request_error=False): 
    ...
    def start_streaming_service(self, period, target, timeout=None, request_error=False): 
    ...
    def stop_streaming_service(self, target, timeout=None, request_error=False): 
    ...
    def clear_streaming_service(self, target, timeout=None, request_error=False): 
    ...
    def enable_robot_infrared_message_notify(self, is_enabled, timeout=None, request_error=False): 
    ...
    def send_infrared_message(self, infrared_code, front_strength, left_strength, right_strength, rear_strength, timeout=None, request_error=False): 
    ...
    def get_temperature(self, id0, id1, handler, timeout=None, request_error=False): 
    ...
    def get_motor_thermal_protection_status(self, handler, timeout=None, request_error=False): 
    ...
    def enable_motor_thermal_protection_status_notify(self, is_enabled, timeout=None, request_error=False): 
    ...
    def get_magnetometer_reading(self, handler, timeout=None, request_error=False): 
    ...
    def get_encoder_counts(self, handler, timeout=None, request_error=False): 
    ...
    def disable_notifications_and_active_commands(self, timeout=None, request_error=False): 
    ...
    def get_bluetooth_advertising_name(self, handler, timeout=None, request_error=False): 
    ...
    def set_all_leds(self, led_group, led_brightness_values, timeout=None, request_error=False): 
    ...
    def get_active_color_palette(self, handler, timeout=None, request_error=False): 
    ...
    def set_active_color_palette(self, rgb_index_bytes, timeout=None, request_error=False): 
    ...
    def get_color_identification_report(self, red, green, blue, confidence_threshold, handler, timeout=None, request_error=False): 
    ...
    def load_color_palette(self, palette_index, timeout=None, request_error=False): 
    ...
    def save_color_palette(self, palette_index, timeout=None, request_error=False): 
    ...
    def release_led_requests(self, timeout=None, request_error=False): 
