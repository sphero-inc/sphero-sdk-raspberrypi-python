...
# Prefix:             RV
# Command Count:      99
# Timestamp:          09/19/2019 @ 18:37:49.245057 (UTC)
...
class SpheroRvrObserver(Observer): 
    ...
    def close(self): 
        if len(self._sensor_control.enabled_sensors) > 0: 
            self._sensor_control.disable_all()
    ...
    def echo(self, data, handler, target, timeout=None): 
        ...
        Returns:
            data (list(uint8_t)): Data that is echoed back. An integer between 0 and 255.
        """
    ...
    def get_mac_address(self, handler, timeout=None): 
        ...
        Returns:
            mac_address (str): A string representing the robot's MAC address.
        """
    ...
    def get_processor_name(self, handler, target, timeout=None): 
        ...
        Returns:
            name (str): name (string up to 16 characters, including optional null terminator)
        """
    ...
    def get_boot_reason(self, handler, timeout=None): 
        ...
        Args:
            handler (function): called when response is received, takes form handler(bootReason).
            timeout (float): maximum time to await a response.

        Returns:
            boot_reason (uint8_t): boot reason
        """
    ...
    def get_last_error_info(self, handler, timeout=None): 
        ...
        Args:
            handler (function): called when response is received, takes form handler(fileName, lineNumber, data).
            timeout (float): maximum time to await a response.

        Returns:
            file_name (list(uint8_t)): file name
            line_number (uint16_t): line number
            data (list(uint8_t)): data (0 to 12 uint8s)
        """
    ...
    def get_core_up_time_in_milliseconds(self, handler, timeout=None): 
        ...
        Returns:
            up_time (uint64_t): None
        """
        command_dict = system_info.get_core_up_time_in_milliseconds(target=1, timeout=timeout)
        self._register_handler(handler, **command_dict)
        self._dal.send_command(**command_dict)

    def get_event_log_status(self, handler, target, timeout=None): 
        """Returns status of event log. Returns error code 6 (Command failed) if no log is found.

        Args:
            handler (function): called when response is received, takes form handler(logCapacity, numberOfBytesUsed, numberOfEventsInLog).
            target (unit8_t): 1 or 2.
            timeout (float): maximum time to await a response.

        Returns:
            log_capacity (uint32_t): None
            number_of_bytes_used (uint32_t): None
            number_of_events_in_log (uint32_t): None
        """
        command_dict = system_info.get_event_log_status(target=target, timeout=timeout)
        self._register_handler(handler, **command_dict)
        self._dal.send_command(**command_dict)

    def get_event_log_data(self, offset, count, handler, target, timeout=None): 
        ...
        Args:
            ...
            handler (function): called when response is received, takes form handler(logData).
            target (unit8_t): 1 or 2.
            timeout (float): maximum time to await a response.

        Returns:
            log_data (list(uint8_t)): None
        """
        command_dict = system_info.get_event_log_data(offset, count, target=target, timeout=timeout)
        self._register_handler(handler, **command_dict)
        self._dal.send_command(**command_dict)

    def enable_sos_message_notify(self, is_enabled, timeout=None): 
    ...
    def on_sos_message_notify(self, handler, timeout=None): 
        """sos_message_notify

        Args:
            handler (function): called when response is received, takes form handler(sosMessage).
            timeout (float): maximum time to await a response.
        """
        command_dict = system_info.on_sos_message_notify(target=1, timeout=timeout)
        self._register_handler(handler, **command_dict)

    def get_sos_message(self, handler, timeout=None): 
        """get_sos_message
    ...
    def get_battery_percentage(self, handler, timeout=None): 
        ...
        Returns:
            percentage (uint8_t): Percentage of battery remaining.
        """
    ...
    def get_battery_voltage_state(self, handler, timeout=None): 
        ...
        Returns:
            state (uint8_t): Value from 0-5. 0 = Charged, 1 = Charging, 2 = Not Charging, 3 = OK, 4 = Low, 5 = Critical.
        """
    ...
    def drive_with_heading(self, speed, heading, flags, timeout=None): 
        ...
        Args:
            ...
            heading (int16_t): 0 to 359 degrees (0 degrees is forward, 90 degrees is to the right, 180 degrees is back, and 270 is to the left)
...
Mask description on BOLT: 32'h0000_00ff: front left sensor 32'h0000_ff00: front right sensor 32'h00ff_0000: back right sensor 32'hff00_0000: back left sensor
    ...
    def on_magnetometer_north_yaw_notify(self, handler, timeout=None): 
        """Returns 0-360 value for reported yaw north.

        Args:
            handler (function): called when response is received, takes form handler(yawDirection).
            timeout (float): maximum time to await a response.
        """
    ...
    def on_motor_current_notify(self, handler, timeout=None): 
        """Motor current measurements with a timestamp.

        Args:
            handler (function): called when response is received, takes form handler(leftMotorCurrent, rightMotorCurrent, upTime).
            timeout (float): maximum time to await a response.
        """
        command_dict = sensor.on_motor_current_notify(target=2, timeout=timeout)
        self._register_handler(handler, **command_dict)

    def enable_motor_current_notify(self, is_enabled, timeout=None): 
    ...
    def get_motor_temperature(self, motor_index, handler, timeout=None): 
        ...
        Returns:
            winding_coil_temperature (float): None
            case_temperature (float): None
        """
        command_dict = sensor.get_motor_temperature(motor_index, target=2, timeout=timeout)
        self._register_handler(handler, **command_dict)
        self._dal.send_command(**command_dict)

    def configure_sensitivity_based_collision_detection(self, method, sensitivity, dead_time, timeout=None): 
        """Configure the collision detection sensitivity

        Args:
            method (uint8_t): None
            sensitivity (uint8_t): None
            dead_time (uint16_t): Minimum time in ms between async messages
            timeout (float): maximum time to await a response.
        """
        command_dict = sensor.configure_sensitivity_based_collision_detection(method, sensitivity, dead_time, target=2, timeout=timeout)
        self._dal.send_command(**command_dict)

    def enable_sensitivity_based_collision_detection_notify(self, is_enabled, timeout=None): 
        ...
        Args:
            ...
            timeout (float): maximum time to await a response.
        """
        command_dict = sensor.enable_sensitivity_based_collision_detection_notify(is_enabled, target=2, timeout=timeout)
        self._dal.send_command(**command_dict)

    def on_sensitivity_based_collision_detected_notify(self, handler, timeout=None): 
        """Collision detection notification

        Args:
            handler (function): called when response is received, takes form handler(time).
            timeout (float): maximum time to await a response.
        """
        command_dict = sensor.on_sensitivity_based_collision_detected_notify(target=2, timeout=timeout)
        self._register_handler(handler, **command_dict)
    ...
    def get_motor_thermal_protection_status(self, handler, timeout=None): 
        ...
        Returns:
            left_motor_temperature (float): None
            left_motor_status (uint8_t): Thermal protection status.
            right_motor_temperature (float): None
    ...
    def get_bluetooth_device_name(self, handler, timeout=None): 
        ...
        Returns:
            name (str): Bluetooth device name.
        """
    ...
    def set_compressed_frame_player_one_color(self, red, green, blue, timeout=None): 
    ...
    def save_compressed_frame_player_animation(self, animation_index, speed_fps, is_fade_enabled, palette_color_count, palette_rgb_values, frame_count, frame_indexes, timeout=None): 
    ...
    def play_compressed_frame_player_animation(self, animation_index, timeout=None): 
    ...
    def play_compressed_frame_player_frame(self, frame_index, timeout=None): 
    ...
    def get_compressed_frame_player_list_of_frames(self, handler, timeout=None): 
        """get_compressed_frame_player_list_of_frames

        Args:
            handler (function): called when response is received, takes form handler(frameIndexes).
            timeout (float): maximum time to await a response.
    ...
    def delete_all_compressed_frame_player_animations_and_frames(self, timeout=None): 
    ...
    def pause_compressed_frame_player_animation(self, timeout=None): 
    ...
    def resume_compressed_frame_player_animation(self, timeout=None): 
    ...
    def reset_compressed_frame_player_animation(self, timeout=None): 
    ...
    def on_compressed_frame_player_animation_complete_notify(self, handler, timeout=None): 
        """compressed_frame_player_animation_complete_notify

        Args:
            handler (function): called when response is received, takes form handler(completeEvent).
            timeout (float): maximum time to await a response.
        """
        command_dict = io.on_compressed_frame_player_animation_complete_notify(target=1, timeout=timeout)
        self._register_handler(handler, **command_dict)

    def assign_compressed_frame_player_frames_to_animation(self, animation_index, start_frame_index, frame_indices, timeout=None): 
    ...
    def save_compressed_frame_player_animation_without_frames(self, animation_index, speed_fps, is_fade_enabled, palette_color_count, palette_rgb_values, total_frame_count, handler, timeout=None): 
        ...
        Args:
            ...
            handler (function): called when response is received, takes form handler(savedAnimations).
            timeout (float): maximum time to await a response.

        Returns:
            saved_animations (list(uint8_t)): None
        """
    ...
    def play_compressed_frame_player_animation_with_loop_option(self, animation_index, is_looping, timeout=None): 
    ...
    def get_color_identification_report(self, red, green, blue, confidence_threshold, handler, timeout=None): 
        ...
        Returns:
            index_confidence_byte (list(uint8_t)): struct array -- index, confidence
        """
    ...
    def get_compressed_frame_player_frame_info_type(self, handler, timeout=None): 
        """get_compressed_frame_player_frame_info_type

        Args:
            handler (function): called when response is received, takes form handler(frameInfoType).
            timeout (float): maximum time to await a response.

        Returns:
            frame_info_type (uint8_t): None
        """
        command_dict = io.get_compressed_frame_player_frame_info_type(target=1, timeout=timeout)
        self._register_handler(handler, **command_dict)
        self._dal.send_command(**command_dict)

    def save_compressed_frame_player_16_bit_frame(self, frame_index, color_index_bit_0, color_index_bit_1, color_index_bit_2, color_index_bit_3, timeout=None): 
