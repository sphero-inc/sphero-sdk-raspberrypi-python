...
# Prefix:             RV
# Command Count:      80
# Timestamp:          08/21/2019 @ 17:53:39.445709 (UTC)
...
class SpheroRvrObserver(Observer): 
    ...
    def configure_collision_detection(self, method, x_threshold, x_speed, y_threshold, y_speed, dead_time, timeout=None): 
        ...
        Args:
            method (uint8_t): None
            x_threshold (uint8_t): None
            x_speed (uint8_t): None
            y_threshold (uint8_t): None
            y_speed (uint8_t): None
            dead_time (uint8_t): Minimum time between async messages in 10ms increments
            timeout (float): maximum time to await a response.
        """
    ...
    def on_collision_detected_notify(self, handler, timeout=None): 
        ...
        Args:
            handler (function): called when response is received, takes form handler(accelerationX, accelerationY, accelerationZ, axis, powerX, powerY, speed, time).
            timeout (float): maximum time to await a response.
        """
    ...
    def set_led_matrix_one_color(self, red, green, blue, timeout=None): 
        """Set entire matrix to a single color.
    ...
    def save_led_matrix_animation_frame(self, frame_index, color_index_bit_0, color_index_bit_1, color_index_bit_2, color_index_bit_3, timeout=None): 
        """save_led_matrix_animation_frame

        Args:
            frame_index (uint16_t): None
            color_index_bit_0 (uint64_t): None
            color_index_bit_1 (uint64_t): None
            color_index_bit_2 (uint64_t): None
            color_index_bit_3 (uint64_t): None
            timeout (float): maximum time to await a response.
        """
    ...
    def save_led_matrix_animation(self, animation_index, speed_fps, is_fade_enabled, palette_color_count, palette_rgb_values, frame_count, frame_indexes, timeout=None): 
    ...
    def play_led_matrix_animation(self, animation_index, timeout=None): 
    ...
    def play_led_matrix_animation_frame(self, frame_index, timeout=None): 
    ...
    def get_led_matrix_animation_frames(self, handler, timeout=None): 
    ...
    def delete_led_matrix_animations_and_frames(self, timeout=None): 
    ...
    def pause_led_matrix(self, timeout=None): 
        """pause_led_matrix
    ...
    def resume_led_matrix(self, timeout=None): 
        """resume_led_matrix
    ...
    def reset_led_matrix(self, timeout=None): 
        """reset_led_matrix
    ...
    def on_led_matrix_animation_complete_notify(self, handler, timeout=None): 
    ...
    def assign_frames_to_animation(self, animation_index, start_frame_index, frame_indices, timeout=None): 
    ...
    def save_led_matrix_animation_without_frames(self, animation_index, speed_fps, is_fade_enabled, palette_color_count, palette_rgb_values, total_frame_count, handler, timeout=None): 
    ...
    def play_led_matrix_animation_with_loop_option(self, animation_index, is_looping, timeout=None): 
