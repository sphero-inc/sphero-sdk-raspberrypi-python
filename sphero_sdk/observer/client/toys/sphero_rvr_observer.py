...
# Prefix:             RV
# Command Count:      82
# Timestamp:          04/06/2020 @ 19:02:27.238178 (UTC)
...
class SpheroRvrObserver(Observer, RvrFwCheckObserver): 
    ...
    def set_control_system_timeout(self, command_timeout, timeout=None): 
    ...
    def reset_drive_target_slew_parameters(self, timeout=None): 
...
Mask description on BOLT: 32'h0000_00ff: front left sensor 32'h0000_ff00: front right sensor 32'h00ff_0000: back right sensor 32'hff00_0000: back left sensor
    ...
    def get_temperature(self, id0, id1, id2, handler, timeout=None): 
        ...
        Args:
            ...
            handler (function): called when response is received, takes form handler(id0, temp0, id1, temp1, id2, temp2).
            timeout (float): maximum time to await a response.
        ...
        Returns:
            ...
            id2 (uint8_t): ID of third requested temperature sensor
            temp2 (float): Temperature of the third requested sensor
        """
