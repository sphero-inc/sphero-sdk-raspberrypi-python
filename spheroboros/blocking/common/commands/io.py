...
# Device ID:          0x1A
# Device Name:        io
# Timestamp:          01/23/2019 @ 18:37:41.329873 (UTC)
...
def set_all_leds(self, led_group, led_brightness_values, target, timeout=None):
...
def set_all_leds_with_64_bit_mask(self, led_group, led_brightness_values, target, timeout=None):
    return self._dal.send_command(
        DevicesEnum.io,
...
def set_all_leds_with_8_bit_mask(self, led_group, led_brightness_values, target, timeout=None):
    return self._dal.send_command(
        DevicesEnum.io,
