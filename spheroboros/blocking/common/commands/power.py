...
# Device ID:          0x13
# Device Name:        power
# Timestamp:          02/08/2019 @ 17:14:09.072167 (UTC)
...
def prepare_for_shutdown(self, target, timeout=None):
    return self._dal.send_command(
        DevicesEnum.power,
...
def on_ready_for_shutdown_notify(self, target, handler=None, timeout=None):
...
def force_battery_refresh(self, target, timeout=None):
    return self._dal.send_command(
        DevicesEnum.power,
