...
# Timestamp:          01/23/2019 @ 18:37:41.330880 (UTC)
...
def set_test_fixture_result(self, test_id, fixture_id, results, target, timeout=None):
...
def get_test_fixture_result(self, test_id, target, timeout=None):
    return self._dal.send_command(
        DevicesEnum.factory_test,
...
def enable_extended_life_test(self, is_enabled, target, timeout=None):
    return self._dal.send_command(
        DevicesEnum.factory_test,
